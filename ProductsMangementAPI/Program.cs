...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("http://localhost:4200", "http://localhost:3200", "http://192.168.100.5:3200","https://localhost:3200", "https://192.168.100.5:3200", "https://dev.myapp.local:3200") //New
            .AllowAnyMethod()
            .AllowAnyHeader()
            .AllowCredentials();
    });
